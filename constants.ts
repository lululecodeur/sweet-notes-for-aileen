...
/**
 * INSERT YOUR ENGLISH NOTES HERE
 * Feel free to add, remove, or edit these messages to make them personal.
 */
...
export const LYRICS = `Moi je n'étais rien
...
Elle doit faire toutes les guerres
